...
export declare class CustomFilterComponent extends FilterDefault implements OnChanges, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDef<CustomFilterComponent, never>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<CustomFilterComponent, "custom-table-filter", never, { "query": "query"; }, {}, never, never>;
}
